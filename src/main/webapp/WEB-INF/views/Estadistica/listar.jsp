...
<body>
	<nav class="p-3 border-gray-200 rounded bg-gray-50 dark:bg-gray-800 dark:border-gray-700 h-55">
    	<div class="container flex flex-wrap items-center justify-between mx-auto">
	      ...
	      <div>
	        <p class="text-5xl">Estadísticas de jugador</p>
	      </div>
	...
	<!-- texto -->
  	<div class="registra relative overflow-x-auto mt-20 mx-32">
	    <p class="text-2xl">Ingresa una nueva estadística</p>
	    <a href="/senati/estadistica/registrar" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
  	...
  	<!-- Tabla -->
	<div class="relative overflow-x-auto mt-20 mx-7">
		<table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
			<!-- Encabezado -->
			<thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
				<tr>
					<th scope="col" class="px-6 py-3">ID</th>
					<th scope="col" class="px-6 py-3">Futbolista</th>
					<th scope="col" class="px-6 py-3">Asistencias</th>
					<th scope="col" class="px-6 py-3">Goles</th>
					<th scope="col" class="px-6 py-3">Balón de Oro</th>
					<th scope="col" class="px-6 py-3">Bota de Oro</th>
					<th scope="col" class="px-6 py-3">Mundial</th>
					<th scope="col" class="px-6 py-3">Champions</th>
					<th scope="col" class="px-6 py-3">Libertadores</th>
					<th scope="col" class="px-6 py-3">Copa de Liga</th>
					<th scope="col" class="px-6 py-3">Partidos</th>
			...
			<tbody>	
				<tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
					<th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">${estadistica.estadisticaId}</th>
					<td class="px-6 py-4">${estadistica.futbolista.nombre}</td>
					<td class="px-6 py-4">${estadistica.asistencias}</td>
					<td class="px-6 py-4">${estadistica.goles}</td>
					<td class="px-6 py-4">${estadistica.balonOro}</td>
					<td class="px-6 py-4">${estadistica.botaOro}</td>
					<td class="px-6 py-4">${estadistica.mundial}</td>
					<td class="px-6 py-4">${estadistica.champions}</td>
					<td class="px-6 py-4">${estadistica.libertadores}</td>
					<td class="px-6 py-4">${estadistica.copaDeLiga}</td>
					<td class="px-6 py-4">${estadistica.partidos}</td>
					
					
					<td class="px-6 py-4">
						<a class="icon" href="/senati/estadistica/editar/${estadistica.estadisticaId}">
						...
						<a class="icon2" href="/senati/estadistica/eliminar/${estadistica.estadisticaId}">
