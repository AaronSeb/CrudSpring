            ...
            <div class="w-1/4 mx-4">
                ...
                <div class="bg-white rounded-xl shadow-lg p-8 mt-10">
                    <form:form name="" method="post" action="" modelAttribute="estadistica" cssClass="flex flex-col space-y-3">
                        ...
                        <div>
                            <form:input cssClass="w-full rounded-md ring-1 ring-gray-300 outline-none focus:ring-2 focus:ring-blue-300 px-4 py-2" type="text" path="asistencias" placeholder="Ingrese cantidad"/>
                        </div>
                        ...
                        <div>
                            <form:input cssClass="w-full rounded-md ring-1 ring-gray-300 outline-none focus:ring-2 focus:ring-blue-300 px-4 py-2" type="text" path="goles" placeholder="Ingrese cantidad"/>
                        </div>
                        ...
                        <div>
                            <form:input cssClass="w-full rounded-md ring-1 ring-gray-300 outline-none focus:ring-2 focus:ring-blue-300 px-4 py-2" type="text" path="balonOro" placeholder="Ingrese cantidad"/>
                        </div>
                        ...
                        <div>
                            <form:input cssClass="w-full rounded-md ring-1 ring-gray-300 outline-none focus:ring-2 focus:ring-blue-300 px-4 py-2" type="text" path="botaOro" placeholder="Ingrese cantidad"/>
                        </div>
                        ...
                        <div>
                            <form:input cssClass="w-full rounded-md ring-1 ring-gray-300 outline-none focus:ring-2 focus:ring-blue-300 px-4 py-2" type="text" path="mundial" placeholder="Ingrese cantidad"/>
                        </div>
                        ...
                        <div>
                            <form:input cssClass="w-full rounded-md ring-1 ring-gray-300 outline-none focus:ring-2 focus:ring-blue-300 px-4 py-2" type="text" path="champions" placeholder="Ingrese cantidad"/>
                        </div>
                        <div>
                            <label class="text-sm font-bold" for="nombre">Libertadores</label>
                        </div>
                        <div>
                            <form:input cssClass="w-full rounded-md ring-1 ring-gray-300 outline-none focus:ring-2 focus:ring-blue-300 px-4 py-2" type="text" path="libertadores" placeholder="Ingrese cantidad"/>
                        </div>
                        <div>
                            <label class="text-sm font-bold" for="nombre">Copa de liga</label>
                        </div>
                        <div>
                            <form:input cssClass="w-full rounded-md ring-1 ring-gray-300 outline-none focus:ring-2 focus:ring-blue-300 px-4 py-2" type="text" path="copaDeLiga" placeholder="Ingrese cantidad"/>
                        </div>
                        ...
                        <div>
                            <form:input cssClass="w-full rounded-md ring-1 ring-gray-300 outline-none focus:ring-2 focus:ring-blue-300 px-4 py-2" type="text" path="partidos" placeholder="Ingrese cantidad"/>
                        </div>
