...
<body>
	<nav class="p-3 border-gray-200 rounded bg-gray-50 dark:bg-gray-800 dark:border-gray-700 h-55">
    	<div class="container flex flex-wrap items-center justify-between mx-auto">
	      ...
	      <div>
	        <p class="text-5xl">Tabla Ligas</p>
	      </div>
  	...
  	<div class="registra relative overflow-x-auto mt-20 mx-32">
	    <p class="text-2xl">Ingresa una nueva liga</p>
	    <a href="/senati/liga/registrar" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
		...
		<table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
			...
			<thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
				<tr>
					...
					<th scope="col" class="px-6 py-3">F.Inicio</th>
					<th scope="col" class="px-6 py-3">Premio $/.</th>
					<th scope="col" class="px-6 py-3">Acciones</th>
				</tr>
			</thead>
			<c:forEach var="li" items="${liga}">
			<tbody>	
				<tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
					<th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">${li.ligaId}</th>
					<td class="px-6 py-4">${li.nombre}</td>
					<td class="px-6 py-4">${li.pais}</td>
					<td class="px-6 py-4">${li.fInicio}</td>
					<td class="px-6 py-4">${li.cantidadPremio}</td>
					<td class="px-6 py-4">
						<a class="icon" href="/senati/liga/editar/${li.ligaId}">
						...
						<a class="icon2" href="/senati/liga/borrar/${li.ligaId}">
