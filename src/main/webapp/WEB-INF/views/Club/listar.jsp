...
<body>
	...
	<nav class="p-3 border-gray-200 rounded bg-gray-50 dark:bg-gray-800 dark:border-gray-700 h-55">
    	<div class="container flex flex-wrap items-center justify-between mx-auto">
	      ...
	      <div>
	        <p class="text-5xl">Lista de Clubs</p>
	      </div>
	...
	<!-- texto -->
  	<div class="registra relative overflow-x-auto mt-20 mx-32">
	    <p class="text-2xl">Ingresa un nuevo Club</p>
	    <a href="/senati/club/registrar" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
  	...
  	<!-- texto2 -->
  	<div class="registra2 relative overflow-x-auto mt-20 mx-32">
	    <p class="text-2xl">Selecciona "</p>
	    <svg class="h-8 w-8 text-green-600"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
	     ...
	     <p class="text-2xl">" Para añadir una competición al Club</p> 
  	</div>

	<!-- Tabla -->
	<div class="relative overflow-x-auto mt-20 mx-1">
		<table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
			...
			<thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
				<tr>
					...
					<th scope="col" class="px-6 py-3">F.Fundación</th>
					<th scope="col" class="px-6 py-3">Correo</th>
					<th scope="col" class="px-6 py-3">Dirección</th>
					<th scope="col" class="px-6 py-3">Pais</th>
					<th scope="col" class="px-6 py-3">Telefono</th>
					<th scope="col" class="px-6 py-3">DT</th>
					<th scope="col" class="px-6 py-3">Dueño</th>
					<th scope="col" class="px-6 py-3">Liga</th>
			...
			<tbody>	
				<tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
					<th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">${club.clubId}</th>
					<td class="px-6 py-4">${club.nombreClub}</td>
					<td class="px-6 py-4">${club.nommbrePresidente}</td>
					<td class="px-6 py-4">${club.feFundacion}</td>
					<td class="px-6 py-4">${club.correo}</td>
					<td class="px-6 py-4">${club.direccion}</td>
					<td class="px-6 py-4">${club.pais}</td>
					<td class="px-6 py-4">${club.telefono}</td>
					<td class="px-6 py-4">${club.direcT}</td>
					<td class="px-6 py-4">${club.duenio}</td>
					<td class="px-6 py-4">${club.liga.nombre}</td>
					
					<td class="px-6 py-4">
						<a class="icon" href="/senati/club/editar/${club.clubId}">
						...
						<a class="icon2" href="/senati/club/eliminar/${club.clubId}">
						...
						<a class="icon3 text-green-600" href="/senati/club_competicion/mostrar/${club.clubId}">
							<svg class="h-8 w-8 text-green-600"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
							<path stroke="none" d="M0 0h24v24H0z"/>  <rect x="4" y="4" width="16" height="16" rx="2" />
							<line x1="9" y1="12" x2="15" y2="12" />  <line x1="12" y1="9" x2="12" y2="15" />
							</svg>
