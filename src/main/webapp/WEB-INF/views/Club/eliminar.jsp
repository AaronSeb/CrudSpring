            ...
            <div class="w-1/3 mx-4">
                ...
                <div class="bg-white rounded-xl shadow-lg p-8 mt-10">
                    <form:form name="" method="post" action="" modelAttribute="club" cssClass="flex flex-col space-y-3">
                        ...
                        <div>
                            <form:input cssClass="w-full rounded-md ring-1 ring-gray-300 outline-none focus:ring-2 focus:ring-blue-300 px-4 py-2" type="text" path="nombreClub" readonly="true"/>
                        </div>
                        <div>
                            <label class="text-sm font-bold" for="nombre">Presidente</label>
                        </div>
                        <div>
                            <form:input cssClass="w-full rounded-md ring-1 ring-gray-300 outline-none focus:ring-2 focus:ring-blue-300 px-4 py-2" type="text" path="nommbrePresidente" readonly="true"/>
                        </div>
                        ...
                        <div>
                            <form:input cssClass="w-full rounded-md ring-1 ring-gray-300 outline-none focus:ring-2 focus:ring-blue-300 px-4 py-2" type="text" path="pais" readonly="true"/>
                        </div>
                        ...
                        <div>
                            <form:input cssClass="w-full rounded-md ring-1 ring-gray-300 outline-none focus:ring-2 focus:ring-blue-300 px-4 py-2" type="text" path="direcT" readonly="true"/>
                        </div>
                        <div>
                            <label class="text-sm font-bold" for="nombre">Liga</label>
                        </div>
                        <div>
                            <form:input cssClass="w-full rounded-md ring-1 ring-gray-300 outline-none focus:ring-2 focus:ring-blue-300 px-4 py-2" type="text" path="liga.nombre" readonly="true" />
                        </div>
